...
LABELS_TO_CREATE = [
    ...
    ("type: feature",         "a2eeef", "ADO Feature / User Story (Task with no scheduling)"),
    ("type: user-story",      "c5def5", "ADO User Story"),
    ("type: feature-request", "8b3e93", "ADO Feature Request"),
    ...
    ("state: in-code-review", "5319e7", "ADO State: In Code Review"),
    ("state: in-test",        "cc317c", "ADO State: In Test"),
    ("state: completed",      "0e8a16", "ADO State: Completed"),
    ("state: declined",       "b60205", "ADO State: Declined"),
    ("state: awaiting-test",  "82cafc", "ADO State: Awaiting Test"),
    ("state: design",         "c2e0c6", "ADO State: Design"),
    # ── Source marker ───────────────────────────────────────────────────────
